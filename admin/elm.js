...
var $author$project$Todo$emptyModel = {countryField: '', descriptionField: '', entries: _List_Nil, field: '', fileField: '', films: _List_Nil, seoTitleField: '', tagsField: '', titleField: '', translationsField: '', uid: 0, visibility: 'All', yearField: 0};
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'countryField',
					$elm$json$Json$Encode$string($.countryField)),
					_Utils_Tuple2(
					'descriptionField',
					$elm$json$Json$Encode$string($.descriptionField)),
					_Utils_Tuple2(
					'entries',
					...
					_Utils_Tuple2(
					'fileField',
					$elm$json$Json$Encode$string($.fileField)),
					_Utils_Tuple2(
					'films',
					$elm$json$Json$Encode$list(
						function ($) {
							return $elm$json$Json$Encode$object(
								_List_fromArray(
									[
										...
										_Utils_Tuple2(
										'seoTitle',
										$elm$json$Json$Encode$string($.seoTitle)),
										_Utils_Tuple2(
										'tags',
												...
												return $elm$json$Json$Encode$object(
													_List_fromArray(
														[
															_Utils_Tuple2(
															'default',
															$elm$json$Json$Encode$bool($._default)),
															_Utils_Tuple2(
															'src',
					...
					_Utils_Tuple2(
					'seoTitleField',
					$elm$json$Json$Encode$string($.seoTitleField)),
					_Utils_Tuple2(
					'tagsField',
					$elm$json$Json$Encode$string($.tagsField)),
					_Utils_Tuple2(
					'titleField',
					$elm$json$Json$Encode$string($.titleField)),
					_Utils_Tuple2(
					'translationsField',
					$elm$json$Json$Encode$string($.translationsField)),
					_Utils_Tuple2(
					'uid',
					...
					_Utils_Tuple2(
					'yearField',
					$elm$json$Json$Encode$int($.yearField))
				]));
	});
						...
						model,
						{
							...
							films: _Utils_ap(
								...
								_List_fromArray(
									[
										{
										country: model.countryField,
										description: model.descriptionField,
										editing: false,
										file: model.fileField,
										id: model.uid,
										seoTitle: model.seoTitleField,
										tags: A2($elm$core$String$split, ' ', model.tagsField),
										title: model.titleField,
										translations: _List_Nil,
										year: model.yearField
									}
									])),
							seoTitleField: '',
							tagsField: '',
...
var $author$project$Todo$UpdateTitleField = function (a) {
	return {$: 'UpdateTitleField', a: a};
};
var $elm$html$Html$form = _VirtualDom_node('form');
var $elm$html$Html$Attributes$placeholder = $elm$html$Html$Attributes$stringProperty('placeholder');
var $author$project$Todo$viewFileCreationForm = function (model) {
	return A2(
		$elm$html$Html$form,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$value(model.titleField),
						$elm$html$Html$Attributes$name('titleInput'),
						$elm$html$Html$Events$onInput($author$project$Todo$UpdateTitleField)
					]),
				_List_Nil)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Todo$viewFileCreationForm(model),
		...
		_List_fromArray(
			[
				...
				A2(
														...
														return A2(
															...
															function (tagsField) {
																return A2(
																		...
																		return A2(
																			...
																			function (films) {
																				return A2(
																												...
																												return A2(
																													...
																													function (countryField) {
																														return $elm$json$Json$Decode$succeed(
																															{countryField: countryField, descriptionField: descriptionField, entries: entries, field: field, fileField: fileField, films: films, seoTitleField: seoTitleField, tagsField: tagsField, titleField: titleField, translationsField: translationsField, uid: uid, visibility: visibility, yearField: yearField});
																													},
																													A2($elm$json$Json$Decode$field, 'countryField', $elm$json$Json$Decode$string));
																											},
																											A2($elm$json$Json$Decode$field, 'descriptionField', $elm$json$Json$Decode$string));
																									},
																									A2(
																					...
																					A2($elm$json$Json$Decode$field, 'fileField', $elm$json$Json$Decode$string));
																			},
																			A2(
																				$elm$json$Json$Decode$field,
																				'films',
																											...
																											return A2(
																												...
																												function (tags) {
																													return A2(
																																					...
																																					return A2(
																																						...
																																						function (description) {
																																							return A2(
																																								...
																																								function (country) {
																																									return $elm$json$Json$Decode$succeed(
																																										{country: country, description: description, editing: editing, file: file, id: id, seoTitle: seoTitle, tags: tags, title: title, translations: translations, year: year});
																																								},
																														...
																														A2($elm$json$Json$Decode$field, 'seoTitle', $elm$json$Json$Decode$string));
																												},
																												A2(
																													$elm$json$Json$Decode$field,
																													'tags',
																												...
																												return A2(
																													...
																													function (src) {
																														return A2(
																															...
																															function (_default) {
																																return $elm$json$Json$Decode$succeed(
																																	{_default: _default, src: src, title: title});
																															},
																	...
																	A2($elm$json$Json$Decode$field, 'seoTitleField', $elm$json$Json$Decode$string));
															},
															A2($elm$json$Json$Decode$field, 'tagsField', $elm$json$Json$Decode$string));
													},
													A2($elm$json$Json$Decode$field, 'titleField', $elm$json$Json$Decode$string));
											},
											A2($elm$json$Json$Decode$field, 'translationsField', $elm$json$Json$Decode$string));
									},
					...
					A2($elm$json$Json$Decode$field, 'yearField', $elm$json$Json$Decode$int)))
			])))(0)}});}(this));